...
import com.binoofactory.alma.almabe.api.user.data.EncryptType;
import com.binoofactory.alma.almabe.common.utils.encrypt.AES256;
import com.binoofactory.alma.almabe.common.utils.encrypt.KISASeedCbc;
...
public class PasswordUtil {
    ...
    private int generateEncryptType() {
        int typeCode = new Date().getSeconds() % EncryptType.values().length;
        return typeCode;
    }
