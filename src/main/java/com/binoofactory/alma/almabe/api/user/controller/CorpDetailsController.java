...
@RestController
@RequestMapping("/corp/details")
@Api(tags = {"회사 상세"}, description = "회사 상세", basePath = "/corp/details")
public class CorpDetailsController {

    private final CorpDetailsService service;

    @Autowired
    public CorpDetailsController(CorpDetailsService service) {
    ...
    public ResponseEntity add(
        @RequestBody CorpDetails instance) throws Exception {
    ...
    public ResponseEntity modify(
        @RequestBody CorpDetails instance,
    ...
    public ResponseEntity<BfListResponse<CorpDetails>> findAll(
    ...
    public ResponseEntity<CorpDetails> findUserId(
