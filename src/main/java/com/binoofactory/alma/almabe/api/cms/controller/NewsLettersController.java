...
@RestController
@RequestMapping("/contents/news-letters")
@Api(tags = {"뉴스 레터"}, description = "뉴스 레터", basePath = "/contents/news-letters")
public class NewsLettersController {

    private final NewsLettersService service;

    @Autowired
    public NewsLettersController(NewsLettersService service) {
    ...
    public ResponseEntity add(
        @RequestBody NewsLetters instance) throws Exception {
    ...
    public ResponseEntity modify(
        @RequestBody NewsLetters instance,
    ...
    public ResponseEntity<BfListResponse<NewsLetters>> findAll(
        ...
        @RequestParam(value = "userPhone", required = false, defaultValue = "") @ApiParam("전화번호") String userPhone,
        @RequestParam(value = "userEmail", required = false, defaultValue = "") @ApiParam("이메일") String userEmail,
        @RequestParam(value = "userName", required = false, defaultValue = "") @ApiParam("이름") String userName,
        @RequestParam(value = "newsletterStatusCode", required = false, defaultValue = "") @ApiParam("뉴스레터상태코드") String newsletterStatusCode,
        ...
        return ResponseUtil.sendResponse(service.findAll(
            ...
            .userEmail(userEmail)
            .userName(userName)
            .newsletterStatusCode(newsletterStatusCode)
            .build(),
    ...
    public ResponseEntity<NewsLetters> findUserId(
