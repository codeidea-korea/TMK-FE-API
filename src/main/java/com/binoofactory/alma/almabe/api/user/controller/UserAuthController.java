...
@Api(tags = {"사용자 권한"}, description = "사용자 계정 권한", basePath = "/users/auth")
public class UserAuthController {
    ...
    public ResponseEntity add(
        @RequestBody UserAuth instance) throws Exception {
    ...
    public ResponseEntity<BfListResponse<UserAuth>> findAll(
    ...
    public ResponseEntity<UserAuth> findUserId(
