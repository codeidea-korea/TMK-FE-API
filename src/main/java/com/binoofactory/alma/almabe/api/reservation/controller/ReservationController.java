...
@Api(tags = {"예약"}, description = "예약", basePath = "/manage/reservations")
public class ReservationController {
    ...
    public ResponseEntity add(
        @RequestBody Reservation instance) throws Exception {
    ...
    public ResponseEntity modify(
        @RequestBody Reservation instance,
    ...
    public ResponseEntity<BfListResponse<Reservation>> findAll(
    ...
    public ResponseEntity<Reservation> findUserId(
