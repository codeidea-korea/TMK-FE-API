...
@Api(tags = {"상담"}, description = "상담", basePath = "/counsels")
public class CounselController {

    private final CounselService service;

    @Autowired
    public CounselController(CounselService service) {
    ...
    public ResponseEntity add(
        @RequestBody Counsel instance) throws Exception {
    ...
    public ResponseEntity<BfListResponse<Counsel>> findAll(
    ...
    public ResponseEntity<Counsel> findUserId(
