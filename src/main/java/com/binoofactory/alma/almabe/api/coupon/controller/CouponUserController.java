...
@RestController
@RequestMapping("/coupon/users")
@Api(tags = {"쿠폰 사용자 보유"}, description = "쿠폰 사용자 보유 매핑", basePath = "/coupon/users")
public class CouponUserController {
    ...
    public ResponseEntity add(
        @RequestBody CouponUser instance) throws Exception {
    ...
    public ResponseEntity modify(
        @RequestBody CouponUser instance,
    ...
    public ResponseEntity<BfListResponse<CouponUser>> findAll(
    ...
    public ResponseEntity<CouponUser> findUserId(
