...
@RestController
@RequestMapping("/config/common/group-code")
@Api(tags = {"공통 코드"}, description = "공통 코드", basePath = "/config/common/group-code")
public class CommonGroupCodeController {

    private final CommonGroupCodeService service;

    @Autowired
    public CommonGroupCodeController(CommonGroupCodeService service) {
    ...
    public ResponseEntity add(
        @RequestBody CommonGroupCode instance) throws Exception {
    ...
    public ResponseEntity modify(
        @RequestBody CommonGroupCode instance,
        @PathVariable("groupCode") @ApiParam("그룹코드") String groupCode,
    ...
    public ResponseEntity<BfListResponse<CommonGroupCode>> findAll(
    ...
    public ResponseEntity<CommonGroupCode> findUserId(
