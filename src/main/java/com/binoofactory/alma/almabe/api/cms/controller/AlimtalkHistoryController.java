...
@RestController
@RequestMapping("/history/alimtalk")
@Api(tags = {"알림톡 내역"}, description = "알림톡 내역", basePath = "/history/alimtalk")
public class AlimtalkHistoryController {

    private final AlimtalkHistoryService service;

    @Autowired
    public AlimtalkHistoryController(AlimtalkHistoryService service) {
