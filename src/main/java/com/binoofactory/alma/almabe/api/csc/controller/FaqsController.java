...
@RestController
@RequestMapping("/faqs")
@Api(tags = {"Faq"}, description = "Faq", basePath = "/faqs")
public class FaqsController {

    private final FaqsService service;

    @Autowired
    public FaqsController(FaqsService service) {
    ...
    public ResponseEntity add(
        @RequestBody Faqs instance) throws Exception {
    ...
    public ResponseEntity<BfListResponse<Faqs>> findAll(
    ...
    public ResponseEntity<Faqs> findUserId(
