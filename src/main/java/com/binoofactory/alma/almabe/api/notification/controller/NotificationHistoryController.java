...
@Api(tags = {"알림 내역"}, description = "알림 내역", basePath = "/users/notifications")
public class NotificationHistoryController {
    ...
    public ResponseEntity add(
        @RequestBody NotificationHistory instance) throws Exception {
    ...
    public ResponseEntity modify(
        @RequestBody NotificationHistory instance,
    ...
    public ResponseEntity<BfListResponse<NotificationHistory>> findAll(
        ...
        return ResponseUtil.sendResponse(service.findAll(
            NotificationHistory.builder().build(),
    ...
    public ResponseEntity<NotificationHistory> findUserId(
