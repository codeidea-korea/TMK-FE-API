...
@Api(tags = {"쿠폰"}, description = "쿠폰", basePath = "/coupons")
public class CouponsController {

    private final CouponsService service;

    @Autowired
    public CouponsController(CouponsService service) {
    ...
    public ResponseEntity add(
        @RequestBody Coupons instance) throws Exception {
    ...
    public ResponseEntity<BfListResponse<Coupons>> findAll(
    ...
    public ResponseEntity<Coupons> findUserId(
