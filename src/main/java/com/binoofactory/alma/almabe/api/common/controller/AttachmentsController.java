...
@Api(tags = {"첨부 파일 매핑"}, description = "첨부 파일 매핑", basePath = "/file/attachments")
public class AttachmentsController {
    ...
    public ResponseEntity add(
        @RequestBody Attachments instance) throws Exception {
    ...
    public ResponseEntity modify(
        @RequestBody Attachments instance,
    ...
    public ResponseEntity<BfListResponse<Attachments>> findAll(
    ...
    public ResponseEntity<Attachments> findUserId(
