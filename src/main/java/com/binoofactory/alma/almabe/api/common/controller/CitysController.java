...
@RestController
@RequestMapping("/config/code/cities")
@Api(tags = {"도시"}, description = "도시", basePath = "/config/code/cities")
public class CitysController {

    private final CitysService service;

    @Autowired
    public CitysController(CitysService service) {
    ...
    public ResponseEntity add(
        @RequestBody Citys instance) throws Exception {
    ...
    public ResponseEntity<BfListResponse<Citys>> findAll(
    ...
    public ResponseEntity<Citys> findUserId(
