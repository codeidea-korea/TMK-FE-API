...
@RestController
@RequestMapping("/config/services/options")
@Api(tags = {"서비스 옵션"}, description = "서비스 옵션", basePath = "/config/services/options")
public class ServiceOptionsController {

    private final ServiceOptionsService service;

    @Autowired
    public ServiceOptionsController(ServiceOptionsService service) {
    ...
    public ResponseEntity add(
        @RequestBody ServiceOptions instance) throws Exception {
    ...
    public ResponseEntity modify(
        @RequestBody ServiceOptions instance,
    ...
    public ResponseEntity<BfListResponse<ServiceOptions>> findAll(
    ...
    public ResponseEntity<ServiceOptions> findUserId(
