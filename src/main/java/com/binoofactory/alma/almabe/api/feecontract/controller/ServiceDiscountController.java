...
@RestController
@RequestMapping("/config/services/discounts")
@Api(tags = {"서비스 할인"}, description = "서비스 할인", basePath = "/config/services/discounts")
public class ServiceDiscountController {

    private final ServiceDiscountService service;

    @Autowired
    public ServiceDiscountController(ServiceDiscountService service) {
    ...
    public ResponseEntity add(
        @RequestBody ServiceDiscount instance) throws Exception {
    ...
    public ResponseEntity modify(
        @RequestBody ServiceDiscount instance,
    ...
    public ResponseEntity<BfListResponse<ServiceDiscount>> findAll(
    ...
    public ResponseEntity<ServiceDiscount> findUserId(
