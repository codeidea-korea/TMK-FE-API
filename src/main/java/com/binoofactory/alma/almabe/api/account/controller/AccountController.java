package com.binoofactory.alma.almabe.api.account.controller;
...
@RestController
@RequestMapping("/accounts/tmk")
@Api(tags = {"정산 (TMK 내부)", "정산"}, description = "정산 (TMK 내부)", basePath = "/accounts/tmk")
