...
@RestController
@RequestMapping("/config/services/discounts/area")
@Api(tags = {"서비스 할인 지역"}, description = "서비스 할인 지역", basePath = "/config/services/discounts/area")
public class ServiceDiscountAreaController {

    private final ServiceDiscountAreaService service;

    @Autowired
    public ServiceDiscountAreaController(ServiceDiscountAreaService service) {
    ...
    public ResponseEntity add(
        @RequestBody ServiceDiscountArea instance) throws Exception {
    ...
    public ResponseEntity modify(
        @RequestBody ServiceDiscountArea instance,
    ...
    public ResponseEntity<BfListResponse<ServiceDiscountArea>> findAll(
        ...
        return ResponseUtil.sendResponse(service.findAll(
            ServiceDiscountArea.builder().build(),
    ...
    public ResponseEntity<ServiceDiscountArea> findUserId(
