...
@RestController
@RequestMapping("/config/common/code")
@Api(tags = {"공통 코드"}, description = "공통 코드", basePath = "/config/common/code")
public class CommonCodeController {
    ...
    public ResponseEntity add(
        @RequestBody CommonCode instance) throws Exception {
    ...
    public ResponseEntity modify(
        @RequestBody CommonCode instance,
    ...
    public ResponseEntity<BfListResponse<CommonCode>> findAll(
    ...
    public ResponseEntity<CommonCode> findUserId(
