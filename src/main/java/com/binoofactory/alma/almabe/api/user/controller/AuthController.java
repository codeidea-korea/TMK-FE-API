...
@Api(tags = {"권한"}, description = "계정 권한", basePath = "/config/auth")
public class AuthController {
    ...
    public ResponseEntity add(
        @RequestBody Auth instance) throws Exception {
    ...
    public ResponseEntity<BfListResponse<Auth>> findAll(
    ...
    public ResponseEntity<Auth> findUserId(
