...
@Api(tags = {"차량정보"}, description = "차량정보", basePath = "/manage/cars")
public class CarsController {
    ...
    public ResponseEntity add(
        @RequestBody Cars instance) throws Exception {
    ...
    public ResponseEntity<BfListResponse<Cars>> findAll(
    ...
    public ResponseEntity<Cars> findUserId(
