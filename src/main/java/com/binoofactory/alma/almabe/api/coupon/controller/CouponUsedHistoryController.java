package com.binoofactory.alma.almabe.api.coupon.controller;
...
@Api(tags = {"쿠폰 사용내역"}, description = "쿠폰 사용내역", basePath = "/coupons/history")
public class CouponUsedHistoryController {

    private final CouponUsedHistoryService service;

    @Autowired
    public CouponUsedHistoryController(CouponUsedHistoryService service) {
    ...
    public ResponseEntity add(
        @RequestBody CouponUsedHistory instance) throws Exception {
    ...
    public ResponseEntity modify(
        @RequestBody CouponUsedHistory instance,
    ...
    public ResponseEntity<BfListResponse<CouponUsedHistory>> findAll(
        ...
        return ResponseUtil.sendResponse(service.findAll(
            CouponUsedHistory.builder().build(),
    ...
    public ResponseEntity<CouponUsedHistory> findUserId(
