...
@RestController
@RequestMapping("/counsel/one-on-one")
@Api(tags = {"1:1상담"}, description = "1:1상담", basePath = "/counsel/one-on-one")
public class OneonOneCounselController {

    private final OneonOneCounselService service;

    @Autowired
    public OneonOneCounselController(OneonOneCounselService service) {
    ...
    public ResponseEntity add(
        @RequestBody OneonOneCounsel instance) throws Exception {
    ...
    public ResponseEntity modify(
        @RequestBody OneonOneCounsel instance,
    ...
    public ResponseEntity<BfListResponse<OneonOneCounsel>> findAll(
    ...
    public ResponseEntity<OneonOneCounsel> findUserId(
