...
@RestController
@RequestMapping("/contents/news-events")
@Api(tags = {"뉴스/이벤트"}, description = "뉴스/이벤트", basePath = "/contents/news-events")
public class NewsEventsController {
    ...
    @Autowired
    public NewsEventsController(NewsEventsService service, DateUtil dateUtil) {
    ...
    public ResponseEntity add(
        @RequestBody NewsEvents instance) throws Exception {
    ...
    public ResponseEntity modify(
        @RequestBody NewsEvents instance,
    ...
    public ResponseEntity<BfListResponse<NewsEvents>> findAll(
        ...
        @RequestParam(value = "newsContentsTypeCode", required = false, defaultValue = "") @ApiParam("뉴스컨텐츠구분코드") String newsContentsTypeCode,
        ...
        return ResponseUtil.sendResponse(service.findAll(
            NewsEvents.builder()
            .title(title)
            .newsContentsTypeCode(newsContentsTypeCode)
    ...
    public ResponseEntity<NewsEvents> findUserId(
