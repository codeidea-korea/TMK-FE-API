package com.binoofactory.alma.almabe.api.reservation.controller;
...
@RestController
@RequestMapping("/manage/branchs")
@Api(tags = {"지점"}, description = "지점", basePath = "/manage/branchs")
public class BranchsController {

    private final BranchsService service;

    @Autowired
    public BranchsController(BranchsService service) {
    ...
    public ResponseEntity add(
        @RequestBody Branchs instance) throws Exception {
    ...
    public ResponseEntity<BfListResponse<Branchs>> findAll(
    ...
    public ResponseEntity<Branchs> findUserId(
