...
@Api(tags = {"메인 컨텐츠"}, description = "메인 컨텐츠", basePath = "/contents/main")
public class MainContentsController {

    private final MainContentsService service;

    @Autowired
    public MainContentsController(MainContentsService service) {
    ...
    public ResponseEntity add(
        @RequestBody MainContents instance) throws Exception {
    ...
    public ResponseEntity modify(
        @RequestBody MainContents instance,
    ...
    public ResponseEntity<BfListResponse<MainContents>> findAll(
        ...
        @RequestParam(value = "mainContentsTypeCode", required = false, defaultValue = "") @ApiParam("메인컨텐츠 구분 코드") String mainContentsTypeCode,
        HttpServletRequest request) throws Exception {

        return ResponseUtil.sendResponse(service.findAll(
            MainContents.builder()
            .mainContentsTypeCode(mainContentsTypeCode)
            .build(),
    ...
    public ResponseEntity<MainContents> findUserId(
