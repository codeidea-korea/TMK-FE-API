...
@RestController
@RequestMapping("/config/code/statues")
@Api(tags = {"국가 코드"}, description = "국가 코드", basePath = "/config/code/statues")
public class StatesController {
    ...
    public ResponseEntity add(
        @RequestBody States instance) throws Exception {
    ...
    public ResponseEntity<BfListResponse<States>> findAll(
    ...
    public ResponseEntity<States> findUserId(
