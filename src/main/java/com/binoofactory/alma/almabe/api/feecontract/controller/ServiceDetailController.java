...
@RestController
@RequestMapping("/config/services/details")
@Api(tags = {"서비스 상세"}, description = "서비스 상세", basePath = "/config/services/details")
public class ServiceDetailController {
    ...
    public ResponseEntity add(
        @RequestBody ServiceDetail instance) throws Exception {
    ...
    public ResponseEntity modify(
        @RequestBody ServiceDetail instance,
    ...
    public ResponseEntity<BfListResponse<ServiceDetail>> findAll(
    ...
    public ResponseEntity<ServiceDetail> findUserId(
